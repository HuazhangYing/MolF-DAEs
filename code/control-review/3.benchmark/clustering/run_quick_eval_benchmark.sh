...
SCRIPT="${ROOT}/code/control-review/1.clustering/1.clustering_quick_eval.py"
RESULT_ROOT="${ROOT}/code/control-review/result/3.benchmark/clustering"

LABELS="${ROOT}/dataset/190w_3D_label_dropna.csv"
DATA2="${ROOT}/dataset/pubchem_molecule3.data2"
DAE="/data/yinghuazhang/MolF-DAEs/result/comparison/pubchemfp_latent_3D_ME.csv"
PCA="/data/yinghuazhang/MolF-DAEs/result/comparison/pubchem_PCA_2_ME.csv"
UMAP="/data/yinghuazhang/MolF-DAEs/result/comparison/pubchem_UMAP_2_ME.csv"
...
main() {
  ...
  require_file "${ROOT}/code/control-review/3.benchmark/outputs/mol2vec/pca3d_full/coords_3d.npy"
  require_file "${ROOT}/code/control-review/3.benchmark/outputs/mol2vec/pca3d_full/ids.npy"
  require_file "${ROOT}/code/control-review/3.benchmark/outputs/mol2vec/umap3d_full/coords_3d.npy"
  require_file "${ROOT}/code/control-review/3.benchmark/outputs/mol2vec/umap3d_full/ids.npy"
  require_file "${ROOT}/code/control-review/3.benchmark/outputs/molai_pca3d_full/coords_3d.npy"
  require_file "${ROOT}/code/control-review/3.benchmark/outputs/molai_pca3d_full/ids.npy"
  require_file "${ROOT}/code/control-review/3.benchmark/outputs/pacmap3d/pubchemfp/full/params_8d7919aa25/coords_3d.npy"
  require_file "${ROOT}/code/control-review/3.benchmark/outputs/pacmap3d/pubchemfp/full/params_8d7919aa25/ids.npy"
  require_file "${ROOT}/code/control-review/3.benchmark/outputs/pacmap3d/pubchemfp/full/params_020c271bf2/coords_3d.npy"
  require_file "${ROOT}/code/control-review/3.benchmark/outputs/pacmap3d/pubchemfp/full/params_020c271bf2/ids.npy"
  require_file "${ROOT}/code/control-review/3.benchmark/outputs/pacmap3d/pubchemfp/full/params_73e89ea872/coords_3d.npy"
  require_file "${ROOT}/code/control-review/3.benchmark/outputs/pacmap3d/pubchemfp/full/params_73e89ea872/ids.npy"
  require_file "${ROOT}/code/control-review/3.benchmark/outputs/pacmap3d/pubchemfp/full/params_03969f1a3d/coords_3d.npy"
  require_file "${ROOT}/code/control-review/3.benchmark/outputs/pacmap3d/pubchemfp/full/params_03969f1a3d/ids.npy"
  require_file "${ROOT}/code/control-review/3.benchmark/outputs/phate3d/pubchemfp/full/params_7ed1639a42/coords_3d.npy"
  require_file "${ROOT}/code/control-review/3.benchmark/outputs/phate3d/pubchemfp/full/params_7ed1639a42/ids.npy"
  require_file "${ROOT}/code/control-review/3.benchmark/outputs/phate3d/pubchemfp/full/params_9ad2278356/coords_3d.npy"
  require_file "${ROOT}/code/control-review/3.benchmark/outputs/phate3d/pubchemfp/full/params_9ad2278356/ids.npy"
  require_file "${ROOT}/code/control-review/3.benchmark/outputs/phate3d/pubchemfp/full/params_6826002097/coords_3d.npy"
  require_file "${ROOT}/code/control-review/3.benchmark/outputs/phate3d/pubchemfp/full/params_6826002097/ids.npy"
  ...
  echo "============================================================"
  echo "[done] all benchmark quick_eval runs finished"
}
