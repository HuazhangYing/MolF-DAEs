...
base_result_dir = f"/data/yinghuazhang/MolF-DAEs/result/pharmachopfp"
data_dir = '/data/yinghuazhang/MolF-DAEs/dataset/PharmacoPFP_molecule3.data2'
...
model_path = os.path.join(base_model_dir, f"pharmacopfp_autoencoder_dim{dim}")
